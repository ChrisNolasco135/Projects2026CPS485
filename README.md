...
Webapp that allows users to login and create and manage SQL databases that utilizes Gemini as the main driver for smart interactions with the database. This allows for easy access and usability for anyone without the requirement of intesive training on SQL and database management. 
